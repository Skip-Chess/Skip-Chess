...
internal val logger: SkipLogger = SkipLogger(subsystem = "skip.chess", category = "SkipChess")
...
open class MainActivity: AppCompatActivity {
    ...
    override fun onStart() {
        super.onStart()
        SkipChessAppDelegate.shared.onStart()
    }

    override fun onResume() {
        super.onResume()
        SkipChessAppDelegate.shared.onResume()
    }

    override fun onPause() {
        super.onPause()
        SkipChessAppDelegate.shared.onPause()
    }

    override fun onStop() {
        super.onStop()
        SkipChessAppDelegate.shared.onStop()
    }

    override fun onDestroy() {
        super.onDestroy()
        SkipChessAppDelegate.shared.onDestroy()
    }

    override fun onLowMemory() {
        super.onLowMemory()
        SkipChessAppDelegate.shared.onLowMemory()
    }
...
internal fun PresentationRootView(context: ComposeContext) {
    ...
    PresentationRoot(defaultColorScheme = colorScheme, context = context) { ctx ->
        ...
        Box(modifier = ctx.modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
            SkipChessRootView().Compose(context = contentContext)
        }
    }
}
